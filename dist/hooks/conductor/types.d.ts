 ...
 */
export type ConductorPhase = 'setup' | 'idle' | 'spec' | 'planning' | 'implementing' | 'reviewing' | 'complete';
/**
 * Status of a track through the conductor pipeline
 */
export type TrackStatus = 'spec' | 'planned' | 'in_progress' | 'review' | 'done' | 'reverted';
/**
