 ...
 */
export function formatContextForPrompt(context: ConductorContext): string {
  const parts: string[] = [];
 ...
 */
export function getSpecPrompt(context: string, trackDescription: string): string {
 ...
 */
export function getPlanPrompt(context: string, spec: string): string {
 ...
 */
export function getImplementTaskPrompt(
  context: string,
  spec: string,
  plan: string,
  task: TrackTask
 ...
 */
export function getCriticPrompt(context: string, spec: string, plan: string): string {
