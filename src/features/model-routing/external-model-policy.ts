...
const DEFAULT_FALLBACK_POLICY: ExternalModelsFallbackPolicy = {
...
export function resolveExternalModel(
  config: ExternalModelsConfig | undefined,
 ...
 */
function guessProviderFromModel(model: string): ExternalModelProvider {
