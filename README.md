...
> **Note: Package naming** — The project is branded as **oh-my-claudecode** (repo, plugin, commands), and this fork publishes CLI tools to npm as [`claudecode-omc`](https://www.npmjs.com/package/claudecode-omc). If you install via npm/bun, use `npm install -g claudecode-omc`.
